---
type: index
title: "oriz-ncert-app — knowledge bundle"
description: "App-specific knowledge for oriz-ncert-app. Cross-cutting family rules live at master `c:/D/oriz/knowledge/`."
tags: [okf, index, app, ncert]
timestamp: 2026-06-21
format_version: okf-v0.1
status: active
---

# oriz-ncert-app — knowledge bundle

This is the per-app OKF-light bundle for **oriz-ncert-app**. App-specific facts only. Cross-cutting family rules / decisions / services live at master [`../../../../knowledge/`](../../../../knowledge/).
...
- **Category**: content
- **Family role**: NCERT textbook directory — browse, search, and download for free.
