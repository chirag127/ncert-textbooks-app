 ...
 *
 * Adapted from oriz-home: the `sites` prop is a FamilySite[] from
 * @chirag127/oriz-ui's FAMILY_SITES export so the cross-family search shows
 * every other site in the umbrella.
 */
